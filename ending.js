...
function resetEndingCollection() {
	...
	localStorage.removeItem(HIDDEN_ENDING_STORAGE_KEY);
	renderEndingCollection();
	endingModal.hidden = true;
	collectionBtn.focus();
}
...
function loadHiddenEnding(ending) {
	endingTitle.textContent = ending.title;
	endingText.innerHTML = ending.text.replace(/\n/g, "<br>");
